...
- Day 29: Frontend fixes: Hero components, list-header alignment, and owner-only visibility fix. Add backend tests.
- Day 30: User custom nickname and profile photo
